...
import { BillingSubscriptionModel } from '../../modules/billing/models/BillingSubscriptionModel.js';
import { BillingUsageCycleModel } from '../../modules/billing/models/BillingUsageCycleModel.js';
import { BillingInvoiceModel } from '../../modules/billing/models/BillingInvoiceModel.js';
import { BillingPaymentModel } from '../../modules/billing/models/BillingPaymentModel.js';
import { BillingAuditLogModel } from '../../modules/billing/models/BillingAuditLogModel.js';
import { BillingWebhookEventModel } from '../../modules/billing/models/BillingWebhookEventModel.js';
import { BillingUsageConfigModel } from '../../modules/billing/models/BillingUsageConfigModel.js';
import { BillingCouponModel } from '../../modules/billing/models/BillingCouponModel.js';

export function setupAssociations() {
    // Billing associations
    Tenant.hasOne(BillingSubscriptionModel, { foreignKey: 'tenant_id', as: 'billingSubscription' });
    BillingSubscriptionModel.belongsTo(Tenant, { foreignKey: 'tenant_id', as: 'tenant' });

    Tenant.hasMany(BillingUsageCycleModel, { foreignKey: 'tenant_id', as: 'billingUsageCycles' });
    BillingUsageCycleModel.belongsTo(Tenant, { foreignKey: 'tenant_id', as: 'tenant' });

    Tenant.hasMany(BillingInvoiceModel, { foreignKey: 'tenant_id', as: 'billingInvoices' });
    BillingInvoiceModel.belongsTo(Tenant, { foreignKey: 'tenant_id', as: 'tenant' });

    Tenant.hasMany(BillingPaymentModel, { foreignKey: 'tenant_id', as: 'billingPayments' });
    BillingPaymentModel.belongsTo(Tenant, { foreignKey: 'tenant_id', as: 'tenant' });

    Tenant.hasMany(BillingAuditLogModel, { foreignKey: 'tenant_id', as: 'billingAuditLogs' });
    BillingAuditLogModel.belongsTo(Tenant, { foreignKey: 'tenant_id', as: 'tenant' });

    Tenant.hasMany(BillingWebhookEventModel, { foreignKey: 'tenant_id', as: 'billingWebhookEvents' });
    BillingWebhookEventModel.belongsTo(Tenant, { foreignKey: 'tenant_id', as: 'tenant' });

    BillingSubscriptionModel.hasMany(BillingPaymentModel, {
        foreignKey: 'billing_subscription_id',
        as: 'payments',
    });
    BillingPaymentModel.belongsTo(BillingSubscriptionModel, {
        foreignKey: 'billing_subscription_id',
        as: 'subscription',
    });

    BillingInvoiceModel.hasMany(BillingPaymentModel, { foreignKey: 'billing_invoice_id', as: 'payments' });
    BillingPaymentModel.belongsTo(BillingInvoiceModel, { foreignKey: 'billing_invoice_id', as: 'invoice' });

    User.hasMany(BillingAuditLogModel, { foreignKey: 'actor_user_id', as: 'billingActions' });
    BillingAuditLogModel.belongsTo(User, { foreignKey: 'actor_user_id', as: 'actor' });

    User.hasMany(BillingUsageConfigModel, { foreignKey: 'updated_by_user_id', as: 'billingConfigUpdates' });
    BillingUsageConfigModel.belongsTo(User, { foreignKey: 'updated_by_user_id', as: 'updatedBy' });

    User.hasMany(BillingCouponModel, { foreignKey: 'created_by_user_id', as: 'billingCoupons' });
    BillingCouponModel.belongsTo(User, { foreignKey: 'created_by_user_id', as: 'createdBy' });
    ...
    Contact.hasMany(WhatsappConversation, { foreignKey: 'contact_id', as: 'conversations' });
    WhatsappConversation.belongsTo(Contact, { foreignKey: 'contact_id', as: 'contact' });
